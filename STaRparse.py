    ...
    for x in vcffiles:
        ...
        for record in my_vcf:
            ...
            for i in samp:
                 ...
                 mdf['Sample_ID'].append(base.strip('.bam.GangSTR.vcf'))
        ...
        for record in my_vcf:
            ...
            for i in samp:
                 ...
                 if record.CHROM[3:] in ["X", "Y"]:
                     if record.CHROM[3:] == "X": Call = float(str(23)+"."+str(record.POS))
                     if record.CHROM[3:] == "Y": Call = float(str(24)+"."+str(record.POS))
                 else:
